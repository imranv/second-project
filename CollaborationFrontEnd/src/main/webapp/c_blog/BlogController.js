                          ...
                          /*	self.ratingvalue=0;*/
                        	self.blogcomment = {
                          	...
                          	self.getSelectedBlog = function getBlog(id){
                          		...
                          		self.addcomment = function(id,bcomment,rating){
                              		{
                              			console.log('saving new blog', self.blogcomment);
                              			self.commentBlog(self.blogcomment,id,bcomment,rating);
                              		}
                              		};
                              		
                              		self.commentBlog = function(blogcomment,id,bcomment,rating){
                              			console.log("create blogs..."+blogcomment.bcomment)
                              			BlogService.commentBlog(blogcomment,id,bcomment,rating)
                              			.then(
                              					self.fetchAllBlogComments,
                              					function(errResponse){
